...
\definecolor{lightgreen}{HTML}{ABE3AE} % ロゴの色(AIITオレンジ）
\definecolor{green}{HTML}{3FB83D} % 基調となる色
\definecolor{lightbrown}{HTML}{D0AC71} % タイトルの背景色
\definecolor{brown}{HTML}{773E28} % メニューの背景色
